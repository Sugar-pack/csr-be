...
type mockConstructorTestingTNewStatusNameRepository interface {
	mock.TestingT
	Cleanup(func())
}

// NewStatusNameRepository creates a new instance of StatusNameRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewStatusNameRepository(t mockConstructorTestingTNewStatusNameRepository) *StatusNameRepository {
	mock := &StatusNameRepository{}
	mock.Mock.Test(t)
