...
func (o *PostUserCreated) WithPayload(payload *models.CreateUserResponse) *PostUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post user created response
func (o *PostUserCreated) SetPayload(payload *models.CreateUserResponse) {
	o.Payload = payload
}
...
/*PostUserDefault Unexpected error.
