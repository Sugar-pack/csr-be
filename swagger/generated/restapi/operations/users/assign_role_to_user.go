...
type AssignRoleToUserHandlerFunc func(AssignRoleToUserParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn AssignRoleToUserHandlerFunc) Handle(params AssignRoleToUserParams, principal interface{}) middleware.Responder {
...
type AssignRoleToUserHandler interface {
	Handle(AssignRoleToUserParams, interface{}) middleware.Responder
}
